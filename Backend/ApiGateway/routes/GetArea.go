...
func GetActions(c *gin.Context) {
	...
	servicesArray = append(servicesArray, actionsList{"Twilio Services", utils.GetEnvKey("TWILIO_API")})
...
func GetReactions(c *gin.Context) {
	...
	servicesArray = append(servicesArray, reactionsList{"Twilio Services", utils.GetEnvKey("TWILIO_API")})
