...
func TestGetActions(t *testing.T) {
	...
	assert.Equal(t, "{\"actions\":[{\"action_id\":11,\"action_type\":0,\"arguments\":[{\"display\":\"City\",\"name\":\"city\",\"type\":\"string\"},{\"display\":\"Kind of event\",\"name\":\"name\",\"type\":\"string\"}],\"description\":\"If there is a new events of the genre you wand in the city indicated, it's trigger\",\"name\":\"New events in this city\"}],\"name\":\"Ticket Master Services\"}", w.Body.String())
	models.ActionsModelsPath = "Models/Actions.json"
}
